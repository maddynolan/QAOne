...
const competitors: Record<string, CompetitorConfig> = {
  katalon: {
    ...
    comparison: [
      ...
      { feature: 'API Testing (gRPC/SOAP/Kafka/MQTT)', flowstral: 'yes', competitor: 'no' },
  ...
  postman: {
    ...
    comparison: [
      ...
      { feature: 'gRPC Testing', flowstral: 'yes', competitor: 'partial' },
      { feature: 'SOAP/WSDL Testing', flowstral: 'yes', competitor: 'partial' },
      { feature: 'Kafka/MQTT/AMQP Testing', flowstral: 'yes', competitor: 'no' },
      { feature: 'WebSocket Testing', flowstral: 'yes', competitor: 'yes' },
    ...
    switchReasons: [
      ...
      'Support 8 protocols (REST, GraphQL, gRPC, SOAP, Kafka, MQTT, WebSocket, AMQP)',
      'Run real load tests with 10,000+ virtual users',
