            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-muted/50 rounded-lg">
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">Version 3.2.2 • ~79 MB</p>
                </div>
                <Button 
                  onClick={() => window.open('https://github.com/maddynolan/QAOne/releases/latest/download/Flowstral.Setup.3.2.2.exe', '_blank')}
                >
