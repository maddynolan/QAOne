 ...
 * @page TestRunDetail
 *
 * Detailed view of a single test run execution. Shows step-by-step results,
 * screenshots, timing data, self-healing events, and defect associations.
 *
 * @features
 * - Step-by-step execution results with pass/fail status
 * - Screenshot and evidence viewer
 * - Self-healing event timeline
 * - Defect linking from failed steps
 * - Execution metadata and environment details
 * - Re-run and comparison options
 *
 * @api /test-runs/* - Test run execution and reporting
 *
 * @dependencies TestRunDetail uses lucide-react icons, shadcn/ui Card, Badge, Button, Progress
 */
