 ...
 * @page CreateTestCase
 *
 * Create new test case form with support for manual and automated test steps.
 * Includes AI-powered test generation, requirement linking, and step management
 * with drag-and-drop reordering.
 *
 * @features
 * - Manual test step creation with expected results
 * - AI-powered test step generation from descriptions
 ...
 * @api /ai/* - AI test generation endpoints
 *
 * @dependencies CreateTestCase uses react-router-dom, lucide-react, shadcn/ui components
 */
