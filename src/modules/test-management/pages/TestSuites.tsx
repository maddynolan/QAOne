 ...
 * @page TestSuites
 *
 * Test suite organization and management page. Allows grouping test cases
 * into logical suites for batch execution, reporting, and release management.
 *
 * @features
 * - Create, edit, and delete test suites
 * - Add/remove test cases to suites
 * - Suite execution with progress tracking
 * - Suite-level reporting and statistics
 * - Search, filter, and bulk operations
 *
 * @api /test-cases/* - Test case and suite endpoints
 *
 * @dependencies TestSuites uses react-router-dom, useState, useEffect, lucide-react, shadcn/ui
 */
