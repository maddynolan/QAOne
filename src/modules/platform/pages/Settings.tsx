 ...
 * @page Settings
 *
 * Application settings and configuration page. Provides controls for
 * theme, notifications, API configuration, LLM provider settings,
 * and user preferences.
 *
 * @features
 * - Theme and appearance settings (light/dark mode)
 ...
 *
 * @dependencies Settings uses shadcn/ui Card, Label, Input, Button, Switch
 */
...
import { PluginManagement } from "@/modules/platform/components/PluginManagement";
