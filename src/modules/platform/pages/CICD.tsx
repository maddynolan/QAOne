 ...
 * @page CICD
 *
 * CI/CD pipeline dashboard and monitoring page. Shows active pipeline status,
 * recent builds, test execution results from CI/CD triggers, and pipeline
 * health metrics.
 *
 * @features
 * - Active pipeline status monitoring
 * - Recent build history with pass/fail indicators
 * - Pipeline-triggered test execution results
 * - Build duration and success rate metrics
 * - Pipeline configuration quick access
 *
 * @dependencies CICD uses lucide-react, shadcn/ui Card, Badge, Button, Progress
 */
