 ...
 * @page CreateDefect
 *
 * Create new defect form. Captures defect details including title, description,
 * severity, priority, steps to reproduce, and file attachments. Supports
 * pre-population from failed test steps via URL search params.
 *
 * @features
 * - Defect detail form (title, description, severity, priority)
 * - Steps to reproduce editor
 * - File and screenshot attachment
 * - Test case and requirement linking
 * - Pre-population from failed test steps
 *
 * @api /defects/* - Defect management endpoints
 *
 * @dependencies CreateDefect uses react-router-dom (useSearchParams), lucide-react, shadcn/ui
 */
