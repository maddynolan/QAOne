 ...
 * @page Defects
 *
 * Defect tracking and management page. Lists all reported defects with
 * filtering, search, and status tracking. Supports creating new defects
 * and linking them to test cases and requirements.
 *
 * @features
 * - Defect listing with search and filtering
 * - Status tracking (open, in-progress, resolved, closed)
 * - Priority and severity classification
 * - Test case and requirement linking
 * - Defect creation and editing
 *
 * @api /defects/* - Defect management endpoints
 *
 * @dependencies Defects uses lucide-react, react-router-dom, shadcn/ui Card, Input, Button
 */
