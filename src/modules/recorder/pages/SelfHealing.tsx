 ...
 * @page SelfHealing
 *
 * Self-healing configuration and history dashboard. Displays healing statistics,
 * success rates, and allows configuration of the 4-layer healing chain
 * (Knowledge, Deterministic, Vision AI, OCR).
 *
 * @features
 * - Healing history with success/failure tracking
 * - Per-layer healing statistics and configuration
 * - Healing rule management and knowledge base
 * - Trend analysis for selector stability
 *
 * @api /api/ai/enhancements/* - AI healing and analysis endpoints
 *
 * @dependencies SelfHealing uses Card, Badge, Button, Switch from shadcn/ui
 */
