/**
 * @module recorder
 * @page ElementRepository
 *
 * Element locator repository for managing and reusing selectors across test cases.
 * Provides a centralized store for element definitions with multiple selector
 * strategies ranked by reliability.
 *
 * @features
 * - Centralized element locator management
 * - Multiple selector strategies per element (CSS, XPath, text, role, etc.)
 * - Element search, filter, and organization
 * - Selector confidence scoring and validation
 * - Copy/reuse selectors across test cases
 *
 * @api /api/playwright/* - Playwright recording endpoints
 *
 * @dependencies ElementRepository uses useState, useEffect, lucide-react icons, shadcn/ui components
 */
