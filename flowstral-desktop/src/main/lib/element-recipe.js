...
const CUSTOM_ELEMENT_ROLES = {
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  // ATLASSIAN DESIGN SYSTEM (Jira, Confluence, Bitbucket, Trello)
  // Uses @atlaskit packages - React components with data-testid
  // ═══════════════════════════════════════════════════════════════════════════
  'ak-button': 'button',
  'ak-field-text': 'textbox',
  'ak-field-textarea': 'textbox',
  'ak-dropdown-menu': 'menu',
  'ak-dropdown-item': 'menuitem',
  'ak-select': 'combobox',
  'ak-checkbox': 'checkbox',
  'ak-radio': 'radio',
  'ak-toggle': 'switch',
  'ak-tabs': 'tablist',
  'ak-tab-list': 'tablist',
  'ak-tab': 'tab',
  'ak-modal': 'dialog',
  'ak-modal-dialog': 'dialog',
  'ak-flag': 'alert',
  'ak-inline-message': 'alert',
  'ak-banner': 'alert',
  'ak-progress-bar': 'progressbar',
  'ak-spinner': 'progressbar',
  'ak-avatar': 'img',
  'ak-avatar-group': 'group',
  'ak-breadcrumbs': 'navigation',
  'ak-calendar': 'grid',
  'ak-datetime-picker': 'combobox',
  'ak-comment': 'article',
  'ak-tag': 'button',
  'ak-tag-group': 'group',
  'ak-tree': 'tree',
  'ak-tree-item': 'treeitem',
  'ak-table-tree': 'treegrid',
  'ak-popup': 'dialog',
  'ak-tooltip': 'tooltip',
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  'garden-button': 'button',
  'garden-input': 'textbox',
  'garden-textarea': 'textbox',
  'garden-select': 'combobox',
  'garden-autocomplete': 'combobox',
  'garden-multiselect': 'listbox',
  'garden-checkbox': 'checkbox',
  'garden-radio': 'radio',
  'garden-toggle': 'switch',
  'garden-range': 'slider',
  'garden-tabs': 'tablist',
  'garden-tab': 'tab',
  'garden-tabpanel': 'tabpanel',
  'garden-menu': 'menu',
  'garden-item': 'menuitem',
  'garden-dropdown': 'menu',
  'garden-modal': 'dialog',
  'garden-drawer': 'dialog',
  'garden-notification': 'alert',
  'garden-alert': 'alert',
  'garden-well': 'region',
  'garden-table': 'table',
  'garden-avatar': 'img',
  'garden-tag': 'button',
  'garden-tooltip': 'tooltip',
  'garden-datepicker': 'combobox',
  'garden-colorpicker': 'dialog',
  'garden-pagination': 'navigation',
  'garden-breadcrumb': 'navigation',
  'garden-stepper': 'list',
  'garden-accordion': 'group',
  
  // ═══════════════════════════════════════════════════════════════════════════
  // WORKDAY CANVAS KIT (@workday/canvas-kit-react)
  // ═══════════════════════════════════════════════════════════════════════════
  'canvas-button': 'button',
  'canvas-text-input': 'textbox',
  'canvas-text-area': 'textbox',
  'canvas-select': 'combobox',
  'canvas-combobox': 'combobox',
  ...
  'canvas-tabs': 'tablist',
  'canvas-tab': 'tab',
  'canvas-tab-panel': 'tabpanel',
  'canvas-menu': 'menu',
  'canvas-menu-item': 'menuitem',
  'canvas-popup': 'dialog',
  'canvas-modal': 'dialog',
  'canvas-side-panel': 'dialog',
  'canvas-toast': 'alert',
  'canvas-banner': 'alert',
  'canvas-table': 'table',
  'canvas-card': 'region',
  'canvas-avatar': 'img',
  'canvas-status-indicator': 'status',
  'canvas-loading-dots': 'progressbar',
  'canvas-skeleton': 'progressbar',
  'canvas-expandable-container': 'group',
  'canvas-pagination': 'navigation',
  'canvas-breadcrumbs': 'navigation',
  'canvas-segmented-control': 'tablist',
  'canvas-color-picker': 'dialog',
  'canvas-date-picker': 'combobox',
  
  // ═══════════════════════════════════════════════════════════════════════════
  // MICROSOFT FLUENT UI WEB COMPONENTS (@fluentui/web-components)
  // Used in Dynamics 365, Power Apps, Microsoft 365, Teams
  // ═══════════════════════════════════════════════════════════════════════════
  'fluent-button': 'button',
  'fluent-text-field': 'textbox',
  'fluent-text-area': 'textbox',
  'fluent-number-field': 'spinbutton',
  'fluent-select': 'combobox',
  'fluent-option': 'option',
  'fluent-listbox': 'listbox',
  'fluent-combobox': 'combobox',
  'fluent-checkbox': 'checkbox',
  'fluent-radio': 'radio',
  'fluent-radio-group': 'radiogroup',
  'fluent-switch': 'switch',
  'fluent-slider': 'slider',
  'fluent-tabs': 'tablist',
  'fluent-tab': 'tab',
  'fluent-tab-panel': 'tabpanel',
  'fluent-menu': 'menu',
  'fluent-menu-item': 'menuitem',
  'fluent-menu-list': 'menu',
  'fluent-dialog': 'dialog',
  'fluent-tooltip': 'tooltip',
  'fluent-progress': 'progressbar',
  'fluent-progress-ring': 'progressbar',
  'fluent-spinner': 'progressbar',
  'fluent-badge': 'status',
  'fluent-avatar': 'img',
  'fluent-card': 'region',
  'fluent-accordion': 'group',
  'fluent-accordion-item': 'group',
  'fluent-tree-view': 'tree',
  'fluent-tree-item': 'treeitem',
  'fluent-data-grid': 'grid',
  'fluent-data-grid-row': 'row',
  'fluent-data-grid-cell': 'gridcell',
  'fluent-breadcrumb': 'navigation',
  'fluent-breadcrumb-item': 'link',
  'fluent-anchor': 'link',
  'fluent-divider': 'separator',
  
  // ═══════════════════════════════════════════════════════════════════════════
  // ORACLE JET (Oracle Cloud/Fusion applications)
  // ═══════════════════════════════════════════════════════════════════════════
  'oj-button': 'button',
  ...
  'oj-select-many': 'listbox',
  'oj-combobox-one': 'combobox',
  'oj-combobox-many': 'listbox',
  ...
  'oj-tab-bar-item': 'tab',
  'oj-menu': 'menu',
  'oj-menu-item': 'menuitem',
  'oj-menu-button': 'button',
  'oj-popup': 'dialog',
  'oj-dialog': 'dialog',
  'oj-message-toast': 'alert',
  'oj-messages': 'alert',
  'oj-progress-bar': 'progressbar',
  'oj-progress-circle': 'progressbar',
  'oj-avatar': 'img',
  'oj-avatar-group': 'group',
  'oj-table': 'table',
  'oj-data-grid': 'grid',
  'oj-list-view': 'list',
  'oj-list-item-layout': 'listitem',
  'oj-tree-view': 'tree',
  'oj-navigation-list': 'navigation',
  'oj-conveyor-belt': 'list',
  'oj-film-strip': 'list',
  'oj-collapsible': 'group',
  'oj-accordion': 'group',
  'oj-train': 'list',
  'oj-breadcrumb': 'navigation',
  'oj-date-picker': 'combobox',
  'oj-time-picker': 'combobox',
  'oj-input-date': 'combobox',
  'oj-input-time': 'combobox',
  'oj-input-date-time': 'combobox',
  'oj-color-palette': 'listbox',
  'oj-color-spectrum': 'slider',
  'oj-file-picker': 'button',
  
  // ═══════════════════════════════════════════════════════════════════════════
  // ADOBE SPECTRUM (Adobe Creative Cloud, Experience Cloud)
  // ═══════════════════════════════════════════════════════════════════════════
  'sp-button': 'button',
  'sp-action-button': 'button',
  'sp-textfield': 'textbox',
  'sp-textarea': 'textbox',
  'sp-number-field': 'spinbutton',
  'sp-picker': 'combobox',
  'sp-menu': 'menu',
  ...
  'sp-dialog': 'dialog',
  'sp-dialog-wrapper': 'dialog',
  'sp-overlay': 'dialog',
  'sp-popover': 'dialog',
  'sp-tooltip': 'tooltip',
  'sp-toast': 'alert',
  'sp-progress-bar': 'progressbar',
  'sp-progress-circle': 'progressbar',
  'sp-avatar': 'img',
  'sp-card': 'region',
  'sp-accordion': 'group',
  'sp-accordion-item': 'group',
  'sp-table': 'table',
  'sp-table-body': 'rowgroup',
  'sp-table-row': 'row',
  'sp-table-cell': 'cell',
  'sp-sidenav': 'navigation',
  'sp-sidenav-item': 'link',
  'sp-breadcrumbs': 'navigation',
  'sp-link': 'link',
  'sp-tag': 'button',
  'sp-tags': 'group',
  
  // ═══════════════════════════════════════════════════════════════════════════
  // TELERIK KENDO UI (React, Angular, Vue, jQuery)
  // Popular in enterprise .NET environments
  // ═══════════════════════════════════════════════════════════════════════════
  'kendo-button': 'button',
  'kendo-textbox': 'textbox',
  'kendo-textarea': 'textbox',
  'kendo-numerictextbox': 'spinbutton',
  'kendo-dropdownlist': 'combobox',
  'kendo-combobox': 'combobox',
  'kendo-multiselect': 'listbox',
  'kendo-autocomplete': 'combobox',
  'kendo-checkbox': 'checkbox',
  'kendo-radiobutton': 'radio',
  'kendo-switch': 'switch',
  'kendo-slider': 'slider',
  'kendo-tabstrip': 'tablist',
  'kendo-menu': 'menubar',
  'kendo-contextmenu': 'menu',
  'kendo-dialog': 'dialog',
  'kendo-window': 'dialog',
  'kendo-notification': 'alert',
  'kendo-grid': 'grid',
  'kendo-treelist': 'treegrid',
  'kendo-treeview': 'tree',
  'kendo-listview': 'list',
  'kendo-panelbar': 'group',
  'kendo-splitter': 'group',
  'kendo-upload': 'button',
  'kendo-datepicker': 'combobox',
  'kendo-timepicker': 'combobox',
  'kendo-datetimepicker': 'combobox',
  'kendo-colorpicker': 'combobox',
  'kendo-editor': 'textbox',
  'kendo-spreadsheet': 'grid',
  'kendo-scheduler': 'grid',
  'kendo-gantt': 'grid',
  
  // ═══════════════════════════════════════════════════════════════════════════
  // AG GRID (Enterprise data grids - used everywhere)
  // ═══════════════════════════════════════════════════════════════════════════
  'ag-grid': 'grid',
  'ag-grid-angular': 'grid',
  'ag-grid-react': 'grid',
  'ag-grid-vue': 'grid',
  'ag-header-cell': 'columnheader',
  'ag-cell': 'gridcell',
  'ag-row': 'row',
  
  // ═══════════════════════════════════════════════════════════════════════════
  // DEVEXTREME (DevExpress - common in enterprise)
  // ═══════════════════════════════════════════════════════════════════════════
  'dx-button': 'button',
  'dx-textbox': 'textbox',
  'dx-textarea': 'textbox',
  'dx-numberbox': 'spinbutton',
  'dx-selectbox': 'combobox',
  'dx-tagbox': 'listbox',
  'dx-lookup': 'combobox',
  ...
  'dx-popover': 'dialog',
  'dx-toast': 'alert',
  'dx-loadpanel': 'progressbar',
  'dx-progressbar': 'progressbar',
  'dx-datagrid': 'grid',
  'dx-treelist': 'treegrid',
  'dx-list': 'list',
  'dx-treeview': 'tree',
  'dx-accordion': 'group',
  'dx-form': 'form',
  'dx-datebox': 'combobox',
  'dx-calendar': 'grid',
  'dx-colorbox': 'combobox',
  'dx-fileuploader': 'button',
  'dx-htmleditor': 'textbox',
  'dx-scheduler': 'grid',
  'dx-gantt': 'grid',
  'dx-diagram': 'img',
};
...
const TESTID_ATTRIBUTES = [
  ...
  'data-testid', // Standard but heavily used
  'data-ds--',
