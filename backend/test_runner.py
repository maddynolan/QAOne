...
"""
Test Runner Service
Executes generated Playwright tests and returns real results
"""
...
class TestRunner:
    ...
    async def run_generated_test(self, test_code: str, test_name: str = "generated_test") -> Dict[str, Any]:
        """Run generated Playwright test code and return real results"""
        try:
...
"""
            ...
            # Don't fail if browser installation fails, just log it
