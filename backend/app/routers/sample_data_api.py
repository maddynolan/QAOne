...
def _get_test_cases_store():
    from app.routers.test_cases_crud_api import _test_cases_store
    return _test_cases_store

def _get_requirements_store():
    from app.routers.requirements_api import get_requirements_store
    return get_requirements_store()

def _get_defects_store():
    from app.routers.defects_api import _defects_store
