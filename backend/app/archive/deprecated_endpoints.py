"""
DEPRECATED ENDPOINTS - Archived from backend/app/main.py

This file contains ~6500 lines of commented-out endpoint code.
These endpoints have been migrated to proper router files under
backend/app/routers/ (organized by domain).

Archived on: 2026-02-15
Original location: backend/app/main.py (lines 520-7033)
"""
